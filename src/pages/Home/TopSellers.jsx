      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Check out our top selling books
          </p>
        </div>
      </div>
      <div className="flex justify-center mb-6">
        <div className="relative inline-block w-full max-w-xs">
          <select
            name="category"
            id="category"
            className="block appearance-none w-full bg-amber-100 border border-amber-300 hover:border-amber-400 px-4 py-2 pr-8 rounded-md shadow leading-tight focus:outline-none focus:shadow-outline"
      ...
      >
        {filteredBooks?.length > 0 &&
          filteredBooks.map((book, index) => (
            <SwiperSlide key={index} className="focus:outline-none py-10">
